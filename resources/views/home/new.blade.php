       ...
       <div class="container">
            ...
            <div class="collapse navbar-collapse">
                 <ul class="nav navbar-nav navbar-right">
                      <li><a href="home.html" class="smoothScroll">Dr. Sara Hamed</a></li>
                      <li class="appointment-btn "><a href="login1.html" >Log Out</a></li>
                 </ul>
            </div>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Registration <b>Visitors</b></h2></div>
                    <div class="col-sm-4">
